...
export const CHECKLIST_ITEMS: ChecklistItem[] = [
  {
    id: "photo_id",
    label: "Carry valid photo ID (see accepted list)",
    category: "before",
  },
  {
    id: "booth_address",
    label: "Know your booth number & address",
    category: "before",
  },
  {
    id: "polling_hours",
    label: "Check polling hours (7 AM - 6 PM)",
    category: "before",
  },
  {
    id: "charge_phone",
    label: "Charge your phone (for maps)",
    category: "before",
  },
  { id: "water_umbrella", label: "Carry water & umbrella", category: "before" },
  {
    id: "queue_booth",
    label: "Queue at your assigned booth",
    category: "at_booth",
  },
  {
    id: "show_id",
    label: "Show photo ID to presiding officer",
    category: "at_booth",
  },
  {
    id: "ink_mark",
    label: "Get indelible ink mark on finger",
    category: "at_booth",
  },
  { id: "ballot_slip", label: "Receive ballot slip", category: "at_booth" },
  {
    id: "enter_alone",
    label: "Enter voting compartment ALONE",
    category: "at_booth",
  },
  {
    id: "press_button",
    label: "Press button next to your candidate",
    category: "at_booth",
  },
  {
    id: "wait_beep",
    label: "Wait for BEEP + VVPAT slip",
    category: "at_booth",
  },
  {
    id: "verify_vvpat",
    label: "Verify printed name on VVPAT",
    category: "at_booth",
  },
  { id: "exit", label: "Exit the booth", category: "at_booth" },
  {
    id: "no_phone",
    label: "Do NOT take phone into voting compartment",
    category: "dont",
  },
  {
    id: "no_photos",
    label: "Do NOT take photos of EVM/ballot",
    category: "dont",
  },
  {
    id: "no_show_vote",
    label: "Do NOT show your vote to anyone",
    category: "dont",
  },
  {
    id: "no_party_symbols",
    label: "Do NOT wear party symbols/colors",
    category: "dont",
  },
];
